...
import { Applicant, addAplicant } from "../features/form/formSlice";

interface ApplicantFormProps {
  onApplicantAdded: (applicant: Applicant) => void; // Changed the prop to expect applicant data
}
...
const ApplicantForm: React.FC<ApplicantFormProps> = ({ onApplicantAdded }) => {
  ...
  const onFinish = (values: any) => {
    if (validateForm()) {
      ...
      console.log("Form Data to be submitted:", newApplicant);
      dispatch(addAplicant(newApplicant));
      // form.resetFields();
      setFormData({
        id: 0,
        name: "",
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <Form form={form} onFinish={onFinish} className="space-y-4">
        ...
        >
          <Checkbox.Group onChange={handleChange} value={formData.techStack}>
